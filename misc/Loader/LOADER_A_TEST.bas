...
Dim Q3$(100), U6$(2), UMP$(50), teamNames$(200), VI$(1), WD$(9), WE$(1)
...
Dim U%(50), UM%(1, 9, 4), UteamIndex%(500)
...
270 For I = 0 To 1
    ...
    YN$ = NY$
    For I1 = 1 To 200: teamNames$(I1) = "": Next
    GoSub 8100
