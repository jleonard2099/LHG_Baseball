...
Declare Sub INFO ()
Declare Sub InitVar ()
Declare Sub INJPIT (P, D, IP%, flagPinchHitter)
...
Declare Sub NEWPITCHER (pIdx, flagPinchHitter, pz)
...
Declare Sub PITSTRAT (flagPinchHitter, pz)
...
Declare Sub RELIEVERS (flagPinchHitter, pz)
