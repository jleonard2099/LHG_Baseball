...
Declare Sub CREDITPUTOUT (I3, fbPitcherCoveringFirst%, AST%, D)
...
Declare Sub OUTATFIRST (currFielder, D, fbUnassisted%, fbPitcherCoveringFirst%)
Declare Sub OUTFIELDERR ()
Declare Sub OUTFLDNAME (currFielder, D)
Declare Sub PICKEDOFF (D, i)
Declare Sub PINCHRUNNER (MS%, A1, S4%, I2, P, pinchRunnerFlag, nbrBalls, nbrStrikes, D, MO)
