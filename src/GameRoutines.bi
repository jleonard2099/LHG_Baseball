...
Declare Sub FLDERR (F%, currFielder%, D, I3, SB%, event%, P)
...
Declare Sub INFO ()
Declare Sub InitVar ()
Declare Sub INJPIT (P, D, flagPitcherInjured%, flagPinchHitter)
...
Declare Sub LineupFromProfile (lineupFound%, P9, skipLineChange%, MAIN_useMgrProf, I$, Q2%)
...
Declare Sub NEWPITCHER (pIdx, flagPinchHitter, flagNewPitcher)
...
Declare Sub RAREPLAYS (dice1000%, dice7500%, flagPitcherInjured%)
...
Declare Sub RELIEVERS (flagPinchHitter, flagNewPitcher)
...
Declare Sub STEAL3RD (TGTBASE%, AA, stealPercent, H0%, D)
